...
<div style="height:17px"></div>
	...
	<div id="content">
		...
		<h2>File List <%=n %></h2>
					...
					<tr bgcolor="yellow">
					<td><center>ID</center></td><td><center>Security status</center></td>
					<td><center>Attacker status</center></td><td><center>Attacker IP</center></td>
					</tr>
							<%
		int total=0;
				...
				String q="select owner_id,security,status,ip from attacker where owner_id='"+n+"'";
