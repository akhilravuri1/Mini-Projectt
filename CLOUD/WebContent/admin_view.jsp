...
function changeSecurityCheck(htmlObj){
	var securityCheck = htmlObj.is(":checked") ? "ON" : "OFF";
	
	$.ajax({
		   url: 'securityCheck',
		   data: {
		      securityCheck : securityCheck,
		      fileKey : htmlObj.attr("alt")
...
<div style="height:17px"></div>
	...
	<td>
	<label class="switch">
  <input type="checkbox" alt="<%=resultSet.getString(3)%>" onchange="changeSecurityCheck($(this))"   <%=resultSet.getBoolean(4) ? "checked" : ""%>>
