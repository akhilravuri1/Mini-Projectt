...
<div id="header">
	...
	<div id="buttons">
      ...
      <a href="security.jsp"  class="but" title="">Security</a>
...
<div style="height:17px"></div>
	...
	<div id="content">
	    ...
	    <div class="line1">
						...
						<br><br><br>
						<center>
							<a href="admin_upload.jsp"> FILE UPLOAD </a><BR><br>
							<a href="admin_view.jsp"> FILE VIEW </a><br></br>
							<a href="AdminResponse.jsp"> USER REQUESTED FILES </a><br></br>
							<a href="UserApproval.jsp"> USER APPROVAL</a>
							</center>
